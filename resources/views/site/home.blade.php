...
@section('content')
    ...
    <div class="main-header">
        <div class="slide">
            <img src="{{asset('site/imgs/header.jpg')}}" class="d-block w-100" alt="...">
    ...
    <section class="about py-5">
        <div class="container">
            <div class="about-cont py-3">
                <p class="pl-4"><span> بنك الدم</span>
            ...
            <div class="container">
                ...
                <div class="slick2">
                    <div class="slick-cont">
                        <div class="card">
                            <img src="{{asset('site/imgs/p1.jpg')}}" class="card-img-top" alt="slick-img">
                    ...
                    <div class="slick-cont">
                        <div class="card">
                            <img src="{{asset('site/imgs/p2.jpg')}}" class="card-img-top" alt="slick-img">
                            <div class="heart-icon"><i class="far fa-heart"></i></div>
                            <div class="card-body">
                                <h5 class="card-title">طرق الوقاية من الأمراض</h5>
                                <p>هذا النص هو مثال لنص ممكن أن يستبدل فى نفس المساحه, لقد تم توليد هذا النص من مولد
            ...
            <div class="row">
                <div class="contact-info col-md-6 col-sm-12 text-center">
                    ...
                    <div class="phone-nm mx-auto">
                        ...
                        <img src="{{asset('site/imgs/whats.png')}}" alt="whats-phone">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="text-center avilb">
                        ...
                        <img src="{{asset('site/imgs/google.png')}}" alt="">
                        <img src="{{asset('site/imgs/ios.png')}}" alt="">
                    </div>
                </div>
                <div class="col-md-6 my-3"><img src="{{asset('site/imgs/App.png')}}" class="img-fluid" alt=""></div>
            </div>
            <!--End row-->
        </div>
        <!--End container-->
