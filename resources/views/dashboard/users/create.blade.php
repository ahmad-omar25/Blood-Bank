...
@section('title') {{__('dashboard.users_create')}} @endsection
@section('content')
    <section class="content-header">
        <h1 style="margin-bottom: 30px;">
            {{__('dashboard.users_create')}}
        </h1>
        <ol class="breadcrumb">
            <li class="active">{{__('dashboard.users_create')}}</li>
        ...
        <div class="box box-primary">
            <form role="form" action="{{route($routeName.'.store')}}" method="POST">
                ...
                @include('dashboard.users.create-custom-tabs')
