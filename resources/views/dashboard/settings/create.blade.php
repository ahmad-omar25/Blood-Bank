...
@section('title') {{__('dashboard.settings_create')}} @endsection
@section('content')
    <section class="content-header">
        <h1 style="margin-bottom: 30px;">
            {{__('dashboard.settings_create')}}
        </h1>
        <ol class="breadcrumb">
            <li class="active">{{__('dashboard.settings_create')}}</li>
            <li><a href="{{route($routeName.'.index')}}">{{__('dashboard.settings')}}</a></li>
